package me.sofdev.smodmode.messages;
...
public class Messages implements Listener {
    ...
    public static void staffJoin(Player joined, Player staffs) {
        staffs.sendMessage(CC.translate(staffJoin.replace("%player%", joined.getName())));
    }

    public static void staffLeave(Player leaved, Player staffs) {
        staffs.sendMessage(CC.translate(staffLeft.replace("%player%", leaved.getName())));
    }
